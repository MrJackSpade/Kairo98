...
The first realistic tranche is **60 manually reviewed games**. It is complete: 20 PC-88 and 40 PC-98 records cover 82 on-disk groups. The 20 Japanese/English PC-98 translation pairs in the third batch share records, with the English HDI hashes where available. Of 120 possible box/screenshot selections, 109 are checked and 11 flagged; none are packaged.
