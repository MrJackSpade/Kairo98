...
Review the captures before assigning a boot outcome; a timed capture can still
show a loading screen, a prompt, or an app preparation error.
"""
...
def main():
    ...
    for number in indices:
        ...
        output = args.output / f"{number:03d}.png"
        if output.exists():
